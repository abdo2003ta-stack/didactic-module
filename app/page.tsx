...
function DidacticGlossary() {
  ...
  const terms = [
    // ================== 1. مفاهيم النقل الديدكتيكي (Chevallard) ==================
    { 
      term: "النقل الديدكتيكي (Transposition Didactique)", 
      def: "سيرورة إبستيمولوجية يتم بموجبها تحويل 'المعرفة العالمة' (Savoir Savant) المنتجة في المختبرات والجامعات، إلى 'معرفة واجب تدريسها' (في المنهاج)، ثم إلى 'معرفة مُدرَّسة' (في الفصل)، وأخيراً إلى 'معرفة مستوعبة' من طرف المتعلم." 
    },
    { 
      term: "النوسفير (Noosphère)", 
      def: "المجال الفكري أو 'الغلاف الجوي' الذي يحيط بالنظام التعليمي، ويتكون من الخبراء، المفتشين، السياسيين، ومؤلفي الكتب المدرسية، وهم المسؤولون عن اختيار المعرفة العالمة وتحويلها إلى مناهج دراسية." 
    },
    { 
      term: "المعرفة العالمة (Savoir Savant)", 
      def: "المعرفة الأكاديمية الخام كما أنتجها العلماء والباحثون المتخصصون، وتتسم بالتجريد والتعقيد وخلوها من السياق البيداغوجي، وهي المصدر الأول للمعرفة المدرسية." 
    },
    { 
      term: "المعرفة الاجتماعية (Pratiques Sociales de Référence)", 
      def: "الممارسات والخبرات الموجودة في المجتمع والتي تُتخذ كمرجع لبناء المحتويات التعليمية (مثل تعليم القراءة، الحساب في المعاملات التجارية)، لربط المدرسة بمحيطها." 
    },
    { 
      term: "اليقظة الديدكتيكية (Vigilance Didactique)", 
      def: "قدرة المدرس المستمرة على الانتباه ومراقبة المسافة الفاصلة بين المعرفة العالمة والمعرفة المدرسة لتجنب تشويه المعرفة أو تبسيطها بشكل يخل بمعناها العلمي." 
    },

    // ================== 2. العقد والمثلث (Brousseau & Houssaye) ==================
    { 
      term: "العقد الديدكتيكي (Contrat Didactique)", 
      def: "مجموع القواعد الضمنية غالباً (والصريحة أحياناً) التي تحدد التزامات وحقوق كل شريك (المدرس والمتعلم) في إطار وضعية تعليمية محددة، وأي خرق لهذا العقد يسبب خللاً في التعلم." 
    },
    { 
      term: "المثلث الديدكتيكي (Triangle Didactique)", 
      def: "نموذج نسقي يمثل الوضعية التعليمية عبر ثلاثة أقطاب: المعرفة، المدرس، والمتعلم. وتنتج عنه ثلاث علاقات: العلاقة الإبستيمولوجية (التعليم)، العلاقة البيداغوجية (التكوين)، وعلاقة التعلم." 
    },
    { 
      term: "القطب الإبستيمولوجي", 
      def: "أحد أضلاع المثلث الديدكتيكي، ويربط بين المدرس والمعرفة. يهتم بكيفية معالجة المادة الدراسية، النقل الديدكتيكي، واختيار المحتويات المناسبة." 
    },
    { 
      term: "القطب السيكولوجي (محور التعلم)", 
      def: "الضلع الرابط بين المتعلم والمعرفة. يركز على استراتيجيات التعلم، التمثلات الذهنية، وآليات اكتساب المعرفة (الاستيعاب والملاءمة)." 
    },

    // ================== 3. نظرية الوضعيات (Guy Brousseau) ==================
    { 
      term: "الوضعية المشكلة (Situation-Problème)", 
      def: "وضعية تعليمية مُهيكلة تضع المتعلم أمام عائق معرفي لا يكفي مخزونه السابق لحله، مما يولد لديه توتراً (صراعاً معرفياً) يدفعه للبحث وبناء معرفة جديدة." 
    },
    { 
      term: "الوضعية أ-ديدكتيكية (Situation A-didactique)", 
      def: "لحظة مفصلية في الدرس ينسحب فيها المدرس (وظيفياً) ليترك المتعلم يواجه المشكلة بمفرده أو مع أقرانه، دون توجيه مباشر، لتعزيز استقلاليته." 
    },
    { 
      term: "التفويض (Dévolution)", 
      def: "فعل بيداغوجي يقوم المدرس بموجبه بتسليم مسؤولية حل المشكلة للمتعلم، بحيث يتبنى المتعلم المشكلة ويعتبر حلها رهاناً شخصياً له." 
    },
    { 
      term: "المأسسة (Institutionnalisation)", 
      def: "مرحلة تأتي بعد بناء المعرفة، حيث يتدخل المدرس ليمنح المعرفة الجديدة صبغة رسمية (قانون، قاعدة)، ويفصلها عن سياق الوضعية لتصبح قابلة للتعميم." 
    },
    { 
      term: "وضعية الفعل (Action)", 
      def: "المرحلة الأولى في الوضعية الديدكتيكية حيث يتفاعل المتعلم مباشرة مع البيئة المادية أو المشكلة لتجريب حلول عملية." 
    },
    { 
      term: "وضعية الصياغة (Formulation)", 
      def: "مرحلة تتطلب من المتعلم صياغة استراتيجيته في رسالة لغوية واضحة (شفهية أو كتابية) ومشاركتها مع متعلم آخر، مما ينمي التواصل." 
    },
    { 
      term: "وضعية التصديق (Validation)", 
      def: "مرحلة يقدم فيها المتعلم البراهين والحجج لإقناع زملائه بصحة الحل المقترح، وتتم فيها مناقشة صدق القضايا." 
    },
    { 
      term: "المتغير الديدكتيكي (Variable Didactique)", 
      def: "عنصر من عناصر الوضعية (مثل حجم الأرقام، الوقت، الأدوات المسموحة) يتحكم فيه المدرس لتغيير درجة صعوبة المهمة وتوجيه استراتيجيات المتعلمين." 
    },

    // ================== 4. التمثلات والعوائق (Bachelard) ==================
    { 
      term: "التمثلات (Représentations)", 
      def: "بنية معرفية قبلية (نظام تفسيري) يكونها المتعلم حول ظاهرة معينة قبل التعلم الرسمي. قد تكون خاطئة علمياً لكنها وظيفية بالنسبة له، ويجب الانطلاق منها لتصحيحها." 
    },
    { 
      term: "العائق الإبستيمولوجي (Obstacle Épistémologique)", 
      def: "صعوبة متأصلة في طبيعة المعرفة نفسها أو في تاريخ تطورها العلمي (مثل صعوبة الانتقال من المحسوس إلى المجرد)، ولا ترتبط بذكاء المتعلم." 
    },
    { 
      term: "العائق الديدكتيكي", 
      def: "صعوبة ناتجة عن الطريقة التي قُدمت بها المعرفة أو المنهجية المتبعة من طرف المدرس (مثل سوء اختيار الوسائل أو التدرج غير المنطقي)." 
    },
    { 
      term: "العائق النشوئي (Ontogénétique)", 
      def: "صعوبة مرتبطة بدرجة النضج البيولوجي والذهني للمتعلم (مثلاً: طفل في الروض لا يستطيع استيعاب مفهوم الزمن التاريخي المجرد)." 
    },
    { 
      term: "القطيعة الإبستيمولوجية", 
      def: "فعل فكري يقوم على هدم المعرفة العامية أو التمثلات الخاطئة لبناء معرفة علمية جديدة. التعلم، حسب باشلار، هو سلسلة من القطائع." 
    },

    // ================== 5. سيكولوجية التعلم (Piaget, Vygotsky) ==================
    { 
      term: "الصراع المعرفي (Conflit Cognitif)", 
      def: "حالة من اللاتوازن والاضطراب الذهني تحدث عندما تصطدم البنى المعرفية السابقة للمتعلم بمعلومات جديدة تناقضها، وهو محرك أساسي للتعلم (بياجيه)." 
    },
    { 
      term: "الصراع السوسيو-معرفي", 
      def: "تطور لمفهوم الصراع المعرفي، يؤكد أن المواجهة بين تصورات المتعلمين المختلفة داخل جماعة القسم هي التي تحفز النمو المعرفي (مدرسة جنيف)." 
    },
    { 
      term: "منطقة النمو القريب (ZPD)", 
      def: "المجال الفاصل بين مستوى النمو الحالي (ما ينجزه الطفل بمفرده) ومستوى النمو الممكن (ما ينجزه بمساعدة)، وهنا يجب أن يتدخل التدريس (فيجوتسكي)." 
    },
    { 
      term: "الاستيعاب والملاءمة (Assimilation & Accommodation)", 
      def: "آليتان للتكيف عند بياجيه: الاستيعاب هو دمج الخبرة الجديدة في البنية الذهنية الحالية، والملاءمة هي تعديل البنية الذهنية لتناسب الخبرة الجديدة." 
    },
    { 
      term: "الميتا-معرفة (Métacognition)", 
      def: "وعي المتعلم بطرق تفكيره الخاصة، وقدرته على التخطيط والمراقبة وتقييم استراتيجيات التعلم التي يستخدمها (التفكير في التفكير)." 
    },

    // ================== 6. آثار/انزلاقات ديدكتيكية (Effets) ==================
    { 
      term: "أثر توباز (Effet Topaze)", 
      def: "انزلاق ديدكتيكي يحدث عندما يقوم المدرس بتبسيط الأسئلة أو التلميح للإجابة بشكل مبالغ فيه لتجنب الخطأ، مما يفرغ التعلم من محتواه." 
    },
    { 
      term: "أثر جوردان (Effet Jourdain)", 
      def: "سوء فهم ديدكتيكي يحدث عندما يفسر المدرس سلوكاً بسيطاً أو إجابة تافهة من المتعلم على أنها دليل على فهم عميق ومعقد." 
    },
    { 
      term: "الشيخوخة البيولوجية للمعرفة", 
      def: "ظاهرة تقادم المعرفة المدرسية وعدم مواكبتها للتطورات العلمية الحديثة، مما يستدعي تدخلاً من النوسفير لتحديث المناهج." 
    },
    { 
      term: "الانزلاق الميتا-معرفي", 
      def: "عندما يتحول اهتمام المدرس من موضوع المعرفة (الهدف) إلى الوسيلة أو التقنية المستخدمة في الشرح، فينشغل المتعلمون بالوسيلة وينسون المضمون." 
    },
    { 
      term: "الاستعمال المفرط للمماثلة", 
      def: "استخدام التشبيهات والأمثلة التقريبية بشكل مفرط مما يؤدي إلى ترسيخ فهم خاطئ أو سطحي للمفهوم العلمي المجرد." 
    },

    // ================== 7. التخطيط والتقويم ==================
    { 
      term: "الكفالة (Compétence)", 
      def: "قدرة مركبة تتيح للمتعلم تعبئة مجموعة مدمجة من الموارد (معارف، مهارات، مواقف) بشكل وظيفي لحل وضعية معقدة تنتمي لفئة من الوضعيات." 
    },
    { 
      term: "القدرة (Capacité)", 
      def: "نشاط ذهني مستعرض (مثل التحليل، التركيب، التصنيف) قابل للتطبيق في مواد مختلفة ولا يرتبط بمحتوى معرفي واحد، وهي المكون الأساسي للكفالة." 
    },
    { 
      term: "الهدف التعلمي", 
      def: "وصف دقيق للنتيجة المنتظرة من المتعلم بعد نهاية نشاط تعليمي، ويجب أن يكون قابلاً للملاحظة والقياس (مثال: أن يميز المتعلم بين الفعل والاسم)." 
    },
    { 
      term: "البيداغوجيا الفارقية", 
      def: "إطار بيداغوجي مرن ينطلق من وجود فروق فردية بين المتعلمين، ويسعى لتنويع طرائق التدريس والوسائل والمسارات لتمكين الجميع من بلوغ نفس الأهداف." 
    },
    { 
      term: "التقويم التشخيصي", 
      def: "إجراء تقويمي ينجز في بداية التعلم لرصد المكتسبات القبلية والتمثلات، بهدف بناء خطط الدعم أو تعديل التخطيط." 
    },
    { 
      term: "التقويم التكويني (Formative)", 
      def: "تقويم مستمر يندمج في سيرورة الدرس، يهدف لتزويد المتعلم بتغذية راجعة (Feedback) حول أدائه لتصحيح الأخطاء وتعديل مسار التعلم فورياً." 
    },
    { 
      term: "التقويم الإشهادي (Sommative)", 
      def: "تقويم ختامي يتم في نهاية مرحلة دراسية، وظيفته إصدار حكم على مستوى المتعلم (نجاح/رسوب) ومنحه شهادة أو نقطة." 
    },
    { 
      term: "شبكة التقويم (Grille d'évaluation)", 
      def: "أداة إجرائية تتضمن معايير ومؤشرات دقيقة لقياس مدى تحقق الأهداف أو الكفايات، مما يضمن موضوعية التنقيط." 
    }
